...
namespace RealEstateAgency4.Controllers
{
    public class ContractsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContractId,DateOfContract,SellerId,BuyerId,DealAmount,ServiceCost,Employee,Fiobuyer")] Contract contract)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContractId,DateOfContract,SellerId,BuyerId,DealAmount,ServiceCost,Employee,Fiobuyer")] Contract contract)
        {
